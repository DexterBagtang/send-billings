                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{url('deleteAnnouncement')}}" method="GET">
                            <div class="row card-header">
                                ...
                                <div onclick="event.preventDefault();if (!confirm('Are you sure to delete ?')) { return false } this.closest('form').submit();" class="btn btn-icon btn-blue-soft mx-2 mt-2">
                            ...
                            @if(count($announcements) > 0)
                                <div class="card-header">
                                    @if(!isset($check))
                                        <div onclick="window.location.href='{{url('mark/Sent')}}'" class="btn btn-twitter mx-2 mt-2"> Mark all</div>
                                    @else
                                        <div onclick="window.location.href='{{url('unmark/Sent')}}'" class="btn btn-twitter mx-2 mt-2"> Unmark all</div>
                                    @endif
                                </div>
                            @endif
                        <!-- /.card-header -->
