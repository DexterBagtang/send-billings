        ...
        <div class="container-xl px-4 mt-4">
            ...
            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
                <div class="me-4 mb-3 mb-sm-0">
                    <h1 class="mb-0">Duplicate Statement of Accounts for the month of {{$month.'-'.$year}}</h1>
                    <div class="small">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul class="nav flex-column fw-bold">
                                            <li class="nav-item text-uppercase text-danger">Duplicate Statement of Account</li>
                        ...
                        <div class="col-lg-8">
                            <div>
                                {{ $duplicateFiles->withQueryString()->links('pagination::bootstrap-results') }}
                                <form action="{{url('duplicateSearch')}}" method="GET" class="float-end">
                            ...
                            <table id="datatablesSimple3">
                                ...
                                @foreach($duplicateFiles as $duplicate)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url("viewDuplicate/$duplicate->filename/$month/$year")}}" class="btn btn-success btn-sm">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                            {{ $duplicateFiles->withQueryString()->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                </div>
            </div>
